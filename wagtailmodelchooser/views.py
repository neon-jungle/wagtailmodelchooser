...
class BaseModelChooserView(BaseChooseView):
    filter_form_class = None
    page_title = "Choose"
    results_template_name = "wagtailmodelchooser/chooser/results.html"
    per_page = 25
...
class ChooseView(ChooseViewMixin, BaseModelChooserView):
    pass


class ChooseResultsView(ChooseResultsViewMixin, BaseModelChooserView):
    pass
...
class ModelChooserViewSet(ChooserViewSet):
    ...
    def widget_class(self):
        return AdminModelChooser(model=self.model, filter_name=self.filter_name)
